...
const NavBar = {
    ...
    boxShadow: "0 0px 10px rgba(0,0,0,0.9)",
    width: "100vw",
marginLeft: "0"}
...
export default function Nav() {
    ...
    return (
        ...
        <nav style={NavBar} className=" fixed top-0 left-0 right-0 z-50 mx-8 mb-24 flex justify-between items-center pt-6 pb-6 font-medium md:mx-16 lg:mx-90">
            <div className="ml-8">
            <TextWithEffect/>
            </div>
